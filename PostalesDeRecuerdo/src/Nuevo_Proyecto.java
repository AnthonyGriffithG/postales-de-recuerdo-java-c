...
public class Nuevo_Proyecto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CBOX_TipoLetra = new javax.swing.JComboBox<>();
        jLabel3 = new javax.swing.JLabel();
        jLabel5 = new javax.swing.JLabel();
        CBOX_TamanoLetra = new javax.swing.JComboBox<>();
        ...
        CBOX_TipoLetra.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Arial", "Advanced Architecture", "Atlantic-Inline-Normal" }));

        jLabel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel3.setText("Tipo Letra:");

        jLabel5.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel5.setText("Tamaño Letra:");

        CBOX_TamanoLetra.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pequeño", "Mediano", "Grande" }));

        jLabel6.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel6.setText("Texto Inferior:");

        jLabel7.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel7.setText("Texto Superior:");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(CBOX_TamanoLetra, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(CBOX_TipoLetra, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(CBOX_TipoLetra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(CBOX_TamanoLetra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(17, 17, 17)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(TXT_NombreProyecto.toString().isEmpty() || TXT_Ruta.toString().isEmpty() || TXT_Texto1.toString().isEmpty() || TXT_Texto2.toString().isEmpty()){
            ...
            String texto2 = TXT_Texto2.getText();
            
            String tipoLetra;
            switch (CBOX_TipoLetra.getSelectedItem().toString()) {
                case "Advanced Architecture":
                    tipoLetra = "2";
                    break;
                case "Atlantic-Inline-Normal":
                    tipoLetra = "3";
                    break;
                default:
                    tipoLetra = "1";
            ...
            String tamanoLetra;
            switch (CBOX_TamanoLetra.getSelectedItem().toString()) {
                case "Mediano":
                    tamanoLetra = "2";
                    break;
                case "Grande":
    ...
    private javax.swing.JComboBox<String> CBOX_TamanoLetra;
    private javax.swing.JComboBox<String> CBOX_TipoLetra;
